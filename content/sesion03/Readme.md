...
---
![Python](./img/01.png) <!-- .element width="20%" -->
##### ¿Qué es Python?
---
...
![Interprete](./img/02.png) <!-- .element width="50%" -->
...
![Guido](./img/03.png) <!-- .element width="30%" -->
...
python3 --version
```
![Instalación](./img/07.png) <!-- .element width="70%" -->
...
![Hola Mundo](./img/08.png) <!-- .element width="50%" -->
...
print ("Hola Mundo")
```
![Hola Mundo](./img/09.png) <!-- .element width="70%" -->
...
![Terminal](./img/10.png) <!-- .element width="60%" -->
...
![Terminal](./img/11.png) <!-- .element width="60%" -->
...
python
```
![Terminal](./img/12.png) <!-- .element width="60%" -->
...
![Terminal](./img/13.png) <!-- .element width="60%" -->
...
![Terminal](./img/14.png) <!-- .element width="60%" --> 
...
git push
```
![Git](./img/15.png) <!-- .element width="60%" -->
